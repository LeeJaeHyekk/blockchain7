...
// Context란 무엇일까 < 전역 상태 관리이다
// React에서 사용하는 변수, 상태값들은 거의 대부분이 지역 변수, 상태 값이다
...
function Child3({}) {
  ...
  return (
    <div>
      <div>child3 {item.num}</div>
      {/* item={num , SetNum} */}
      item.num = 버츄얼돔 변수 item.SetNum = 버츄얼돔 을 hook으로 useState를
      사용해서 Num 변화량을 컨트롤 할수 있는 거 onClick=
      {(e) => {
        e.stopPropagation();
