...
// 예를 들어 일반적인 함수는 New로 동적할당 할때마다 A라는 함수가 있으면
// 동적할당한 B와C에 둘다 생성한 객체안에 함수가 들어있지만 static으로 선언하면
// 클래스에 전역 함수 하나만 있게 된다. 동적할때 마다 될 필요가 없는 함수는 static으로 선언해주는것이 좋다.
